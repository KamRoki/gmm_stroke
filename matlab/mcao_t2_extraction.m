% Stroke Extraction T2w using GMM algorithm
...
data = {'5'};
diff_clim = [0, 0.001];
brain_mask = load('/Users/kamil/Documents/my_softwares/gmm_stroke/data/brain_anat_mask.mat').brain_mask;
...
img = rot90(permute(img, [2, 1, 3]), 2); % shape: [x, y, slice]
...
sgtitle('T2-Weighted Stroke Brain Images');
